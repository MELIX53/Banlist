...
class MinecraftRcon
{
    ...
    public function Data(array $sendData){
        $string = json_encode($sendData);
        if(!$this->WriteData(self::SERVERDATA_ARRAY, $string)){
            return false;
        }
        ...
        return unserialize(base64_decode($data["String"]));
    }
